...
var TESTIMONIALS = [
  ...
  {
    quote: "部署は違いましたが、以前商談記録のdocumentを拝見したところ、事前準備の量や精度に驚いた記憶があります。一人一人のお客様に向き合っているからこそ、本質的な課題の顕在化や価値訴求が出来るのだなと思いました。\nまた、社内で積極的に自身のナレッジを共有しており、業務委託の方と思えない成果を出されていた印象です！大半の方が正社員と認識していると思います。笑",
    name: "A.O",
    company: "",
    relation: "同僚",
  ...
  {
    quote: "商談における丁寧な接客と、それによって培われたお客様からの深い信頼が非常に印象的です。\n単にシステムを紹介して契約を目指すのではなく、「どうすればこの企業の潜在的な課題まで解決できるか」を第一に考え、丁寧なヒアリングと本質的な提案を行っていました。\nお客様目線で見れるからこそ、ご指名で再度商談をご希望されるお客様も多かったです。\nまた、社内でも他ファンクションへの配慮を怠らずコミュニケーションもしっかり取ってくださったので社内からの与信も高かったです。",
    name: "M",
    company: "",
    relation: "同僚",
    goodPoints: "潜在ニーズを引き出すヒアリング, 相手の知識レベルに合わせた分かりやすい説明, ナレッジの横展開, 社内営業力"
  },
  {
