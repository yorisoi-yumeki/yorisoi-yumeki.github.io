...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("edit-mode-generate").addEventListener("click", function () {
      ...
      // #voice-theme-bars / #voice-panel-list / #voice-bars-caption も同じ理由
      ...
      var clonedVoiceBarsCaption = clone.querySelector("#voice-bars-caption");
      if (clonedVoiceBarsCaption) clonedVoiceBarsCaption.textContent = "";
